...
const walkInVolumeIc = createStaticURL('app/dashboard_conf19_examples/emergency_department_ops/WalkIn_ic.svg');
const waitTimeIc = createStaticURL('app/dashboard_conf19_examples/emergency_department_ops/WaitTime_ic.svg');
const triagePerHourIc = createStaticURL('app/dashboard_conf19_examples/emergency_department_ops/TriagePerHour_ic.svg');
const patientNurseRatioIc = createStaticURL('app/dashboard_conf19_examples/emergency_department_ops/PatientNurseRatio_ic.svg');
const ambulanceVolumeIc = createStaticURL('app/dashboard_conf19_examples/emergency_department_ops/Ambulance_ic.svg');
...
export default {
	...
	"visualizations": {
		...
		"viz_xQu2AfOC": {
			...
			"options": {
				"color": "#A8ACB1",
				"content": "Emergency Departments are under increasing pressure due to the high demand for access to Emergency Services. Emergency Departments are often the first contact many patients and their relatives or care givers have with a hospital.\n",
				"fontSize": 12
			}
		}
	},
